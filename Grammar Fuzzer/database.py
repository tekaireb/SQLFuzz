...
class Query:
    INSERT_PERSON = "INSERT INTO Users_DB VALUES('{}','{}', {}, '{}', '{}')"
    SELECT_ALL = "SELECT * FROM Users_DB"
    CREATE_PERSON_TABLE = "CREATE TABLE if not exists Users_DB (name VARCHAR(64), age INT, email_address VARCHAR(64), phone_number VARCHAR(64), ssn VARCHAR(11) PRIMARY KEY)"
